    ...
    <div class="quotation-header-bar">
        <div class="qh-left">
            <div class="qh-title-group">
                <h2 id="page-title-display">Create Itinerary - Day 1</h2>
                <span class="qh-status-badge">Draft</span>
            </div>
            ...
            <div class="q-glass-panel" style="margin-bottom: 16px;">
                ...
                <div class="form-row-grid-2">
                    ...
                    <div class="form-group-custom">
                        ...
                        <input type="text" id="input-quotation-title" class="q-input" placeholder="e.g. Kerala Family Tour">
                    </div>
                </div>
                ...
                <div class="form-row-grid trans-row-1" style="margin-top: 16px;">
                    <div class="form-group-custom">
                        ...
                        <input type="number" id="input-global-adults" class="q-input" value="0" min="0">
                    </div>
                    <div class="form-group-custom">
                        <label for="input-global-children">Children</label>
                        <input type="number" id="input-global-children" class="q-input" value="0" min="0">
                    </div>
                    <div class="form-group-custom">
                        <label for="input-global-infants">Infants</label>
                        <input type="number" id="input-global-infants" class="q-input" value="0" min="0">
                    </div>
                </div>
                ...
                <div class="form-group-custom" style="margin-top: 16px;">
                    ...
                    <div class="image-upload-wrapper">
                        ...
                        <img src="" class="image-preview" alt="Banner Preview" style="border-radius: 8px;">
                        <div class="image-remove-btn"><i class="fa-solid fa-xmark"></i></div>
                    </div>
                </div>
                <div class="form-group-custom" style="margin-top: 16px;">
                    <label for="input-terms-conditions">Terms & Conditions</label>
                    <textarea class="ckeditor-init" id="input-terms-conditions" name="terms_and_conditions"></textarea>
                </div>
            </div>
...
<script>
    // State management for Itinerary Days
    let days = [
        {
            dayNumber: 1,
            date: "",
    ...
    // Local storage key
    const STORAGE_KEY = "vaago_quotation_draft";
        ...
        try {
            ...
            if (rawDraft) {
                ...
                if (draft.termsAndConditions) {
                    const el = document.getElementById("input-terms-conditions");
                    if (el) {
                        if (window.editorInstances && window.editorInstances['input-terms-conditions']) {
                            window.editorInstances['input-terms-conditions'].setData(draft.termsAndConditions);
                        } else {
                            el.value = draft.termsAndConditions;
                        }
                    }
                }
    ...
    function saveDraftToLocalStorage() {
        try {
            ...
            let termsValue = "";
            if (window.editorInstances && window.editorInstances['input-terms-conditions']) {
                termsValue = window.editorInstances['input-terms-conditions'].getData();
            } else {
                termsValue = document.getElementById("input-terms-conditions")?.value || "";
            }
    ...
    document.addEventListener("DOMContentLoaded", function () {
        // Load draft if it exists in local storage
    ...
    function loadDayData(index) {
        ...
        // Update page title
        document.getElementById("page-title-display").innerText = `Create Itinerary - Day ${day.dayNumber}`;
    }
    ...
    function removeImage(idx) {
        ...
        // Update summary cover image if first destination image changes
    ...
    function duplicateDay() {
        ...
        // Shift date by 1 day from the last day
        const lastDay = days[days.length - 1];
        if (lastDay && lastDay.date) {
            const parts = lastDay.date.split('-');
            const d = new Date(parts[0], parts[1] - 1, parts[2]);
    ...
    // Show custom options menu (three dots click placeholder)
    ...
    // Simulate clicking Map selection
    ...
    // Simulate Hotel card link clicking
    ...
    function openPreviewModal(scope) {
        ...
        if (scope === "day") {
            ...
            // Add costing details & terms at the bottom of full preview
    ...
    // Helper: render single day preview
