...
<div class="admin-page-panel">
    <div class="page-panel-header">
        <div class="panel-header-action-container">
            <h3><i class="fa-solid fa-plus"></i> Add New Blog</h3>
    ...
    <div class="page-panel-body">
        <form action="{{ url('/admin/blogs') }}" method="POST" enctype="multipart/form-data" class="validate-form">
            @csrf
            
            <div class="form-group">
                <label for="title">Blog Title <span class="text-danger">*</span></label>
                <input type="text" name="title" id="title" class="modern-input" placeholder="Enter blog title" value="{{ old('title') }}" required>
                @error('title')
            ...
            <div class="form-group">
                ...
                <input type="text" name="slug" id="slug" class="modern-input" placeholder="Enter unique slug" value="{{ old('slug') }}" required>
                @error('slug')
                    <span class="text-danger" style="font-size: 0.85rem; margin-top: 4px; display: block;">{{ $message }}</span>
                @enderror
            </div>
