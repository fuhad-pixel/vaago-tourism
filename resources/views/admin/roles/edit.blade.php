...
<div class="admin-page-panel">
    ...
    <div class="page-panel-header">
        <div class="panel-header-action-container">
            <h3><i class="fa-solid fa-pen"></i> Edit Role: {{ $role->name }}</h3>
        ...
        <div class="role-header-banner">
            <div class="role-header-left">
                ...
                <div class="role-header-text">
                    <h2>Edit Role</h2>
                    <p>Update role name and modify assigned permissions</p>
                </div>
            </div>
        ...
        <div class="role-form-body">
            <form action="{{ route('roles.update', $role->id) }}" method="POST" class="validate-form">
                ...
                <div class="input-icon-wrapper">
                    ...
                    <input type="text" name="name" value="{{ old('name', $role->name) }}" placeholder="e.g. Editor" required>
                    @error('name')
                ...
                <div class="permissions-grid">
                    @foreach($permissions as $permission)
                        ...
                        <div class="permission-card">
                            ...
                            <label class="switch">
                                <input type="checkbox" name="permissions[]" value="{{ $permission->name }}" class="perm-checkbox" {{ in_array($permission->name, $rolePermissions) ? 'checked' : '' }}>
