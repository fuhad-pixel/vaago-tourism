...
<div class="admin-page-panel">
    <div class="page-panel-header">
        <div class="panel-header-action-container">
            <h3><i class="fa-solid fa-pen-to-square"></i> Edit Activity</h3>
    ...
    <div class="page-panel-body">
        <form action="{{ route('activities.update', $activity->id) }}" method="POST" class="validate-form">
            @csrf
            @method('PUT')
            ...
            <div class="form-section-grid" style="grid-template-columns: repeat(2, 1fr); gap: 24px;">
                ...
                <div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="name" id="name" class="modern-input" placeholder="e.g. Scuba Diving" value="{{ old('name', $activity->name) }}" required>
                    ...
                    <div class="form-group">
                        ...
                        <select name="destination_id" id="destination_id" class="modern-input select2-init" required>
                            ...
                            @foreach($destinations as $destination)
                                <option value="{{ $destination->id }}" {{ old('destination_id', $activity->destination_id) == $destination->id ? 'selected' : '' }}>{{ $destination->name }}</option>
                            @endforeach
                        </select>
                ...
                <div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="cost_adult" id="cost_adult" class="modern-input" placeholder="0.00" step="0.01" min="0" value="{{ old('cost_adult', $activity->cost_adult) }}" required>
                    ...
                    <div style="display: flex; gap: 16px;">
                        <div class="form-group" style="flex: 1;">
                            ...
                            <input type="number" name="cost_child" id="cost_child" class="modern-input" placeholder="0.00" step="0.01" min="0" value="{{ old('cost_child', $activity->cost_child) }}">
                        ...
                        <div class="form-group" style="flex: 1;">
                            ...
                            <input type="number" name="cost_infant" id="cost_infant" class="modern-input" placeholder="0.00" step="0.01" min="0" value="{{ old('cost_infant', $activity->cost_infant) }}">
                            <small style="color: #9CA3AF; font-size: 0.75rem;">Leave empty if free or N/A</small>
