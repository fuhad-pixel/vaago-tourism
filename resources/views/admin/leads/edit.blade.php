...
<div class="admin-page-panel">
    <div class="page-panel-header">
        <div class="panel-header-action-container">
            <h3><i class="fa-solid fa-pen-to-square"></i> Edit Lead</h3>
    ...
    <div class="page-panel-body">
        <form action="{{ route('leads.update', $lead->id) }}" method="POST" class="validate-form">
            @csrf
            @method('PUT')
            ...
            <div class="form-section-grid" style="grid-template-columns: repeat(2, 1fr); gap: 24px;">
                ...
                <div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="name" id="name" class="modern-input" placeholder="Enter full name" value="{{ old('name', $lead->name) }}" required>
                        @error('name')<span class="text-danger" style="font-size: 0.85rem;">{{ $message }}</span>@enderror
                    </div>

                    <div class="form-group">
                        <label for="email">Email <span class="text-danger">*</span></label>
                        <input type="email" name="email" id="email" class="modern-input" placeholder="Enter email address" value="{{ old('email', $lead->email) }}" required>
                        @error('email')<span class="text-danger" style="font-size: 0.85rem;">{{ $message }}</span>@enderror
                    </div>

                    <div class="form-group">
                        <label for="phone">Phone</label>
                        <input type="text" name="phone" id="phone" class="modern-input" placeholder="Enter phone number" value="{{ old('phone', $lead->phone) }}">
                    ...
                    <div style="display: flex; gap: 16px;">
                        <div class="form-group" style="flex: 1;">
                            ...
                            <input type="number" name="adults" id="adults" class="modern-input" placeholder="0" min="0" value="{{ old('adults', $lead->adults) }}">
                            @error('adults')<span class="text-danger" style="font-size: 0.85rem;">{{ $message }}</span>@enderror
                        </div>
                        <div class="form-group" style="flex: 1;">
                            <label for="children">Children</label>
                            <input type="number" name="children" id="children" class="modern-input" placeholder="0" min="0" value="{{ old('children', $lead->children) }}">
                            @error('children')<span class="text-danger" style="font-size: 0.85rem;">{{ $message }}</span>@enderror
                        </div>
                        <div class="form-group" style="flex: 1;">
                            <label for="infants">Infants</label>
                            <input type="number" name="infants" id="infants" class="modern-input" placeholder="0" min="0" value="{{ old('infants', $lead->infants) }}">
                ...
                <div>
                    ...
                    <div style="display: flex; gap: 16px;">
                        <div class="form-group" style="flex: 1;">
                            ...
                            <input type="date" name="arrival_date" id="arrival_date" class="modern-input" value="{{ old('arrival_date', $lead->arrival_date ? $lead->arrival_date->format('Y-m-d') : '') }}">
                            @error('arrival_date')<span class="text-danger" style="font-size: 0.85rem;">{{ $message }}</span>@enderror
                        </div>
                        <div class="form-group" style="flex: 1;">
                            <label for="departure_date">Departure Date</label>
                            <input type="date" name="departure_date" id="departure_date" class="modern-input" value="{{ old('departure_date', $lead->departure_date ? $lead->departure_date->format('Y-m-d') : '') }}">
                    ...
                    <div style="display: flex; gap: 16px;">
                        <div class="form-group" style="flex: 1;">
                            ...
                            <input type="text" name="source" id="source" class="modern-input" placeholder="e.g. Website, Walk-in, Referral" value="{{ old('source', $lead->source) }}">
                            @error('source')<span class="text-danger" style="font-size: 0.85rem;">{{ $message }}</span>@enderror
                        </div>
                        <div class="form-group" style="flex: 1;">
                            <label for="budget">Budget</label>
                            <input type="number" name="budget" id="budget" class="modern-input" placeholder="e.g. 5000" step="0.01" min="0" value="{{ old('budget', $lead->budget) }}">
            ...
            <div class="form-section-grid" style="grid-template-columns: 1fr; margin-top: 16px;">
                <div>
                    <div class="form-group">
                        ...
                        <textarea name="notes" id="notes" class="modern-input" rows="4" placeholder="Enter any additional notes here...">{{ old('notes', $lead->notes) }}</textarea>
            ...
            <div style="display: flex; justify-content: flex-end; gap: 12px;">
                ...
                <button type="submit" class="modern-btn">
                    <i class="fa-solid fa-floppy-disk"></i> Update Lead
                </button>
            </div>
        </form>
    </div>
