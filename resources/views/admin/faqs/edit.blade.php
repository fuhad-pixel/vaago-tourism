...
<div class="admin-page-panel">
    <div class="page-panel-header">
        <div class="panel-header-action-container">
            <h3><i class="fa-solid fa-pen-to-square"></i> Edit FAQ</h3>
    ...
    <div class="page-panel-body">
        <form action="{{ url('/admin/faqs/' . $faq->id) }}" method="POST" class="validate-form">
            @csrf
            @method('PUT')
            ...
            <div class="form-section-grid" style="grid-template-columns: 1fr;">
                <div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="question" id="question" class="modern-input" placeholder="Enter question" value="{{ old('question', $faq->question) }}" required>
                        @error('question')
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="answer" id="answer" class="modern-input ckeditor-init" rows="5" required>{{ old('answer', $faq->answer) }}</textarea>
                        @error('answer')
                            <span class="text-danger" style="font-size: 0.85rem; margin-top: 4px; display: block;">{{ $message }}</span>
                        @enderror
                    </div>
            ...
            <div style="display: flex; justify-content: flex-end; gap: 12px;">
                ...
                <button type="submit" class="modern-btn">
                    <i class="fa-solid fa-floppy-disk"></i> Update FAQ
                </button>
            </div>
        </form>
    </div>
