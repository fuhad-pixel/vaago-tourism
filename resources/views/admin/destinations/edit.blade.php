...
<div class="admin-page-panel">
    <div class="page-panel-header">
        <div class="panel-header-action-container">
            <h3><i class="fa-solid fa-pen-to-square"></i> Edit Destination: {{ $destination->name }}</h3>
    ...
    <div class="page-panel-body">
        <form action="{{ url('/admin/destinations/' . $destination->id) }}" method="POST" enctype="multipart/form-data" class="validate-form">
            @csrf
            @method('PUT')
