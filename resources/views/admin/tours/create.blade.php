...
<div class="admin-page-panel">
    <div class="page-panel-header">
        <div class="panel-header-action-container">
            <h3><i class="fa-solid fa-plus"></i> Add New Tour</h3>
            ...
            <div class="form-section-grid">
                ...
                <div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="name" id="name" class="modern-input" placeholder="Enter tour name" value="{{ old('name') }}" required>
                    ...
                    <div class="form-group">
                        <label for="slug">Tour Slug (Auto-generated) <span class="text-danger">*</span></label>
                        <input type="text" name="slug" id="slug" class="modern-input" placeholder="tour-slug" value="{{ old('slug') }}" required>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="overview" id="overview" class="modern-input ckeditor-init" rows="5">{{ old('overview') }}</textarea>
                    </div>

                    <div class="form-group">
                        <label for="inclusions">Inclusions</label>
                        <textarea name="inclusions" id="inclusions" class="modern-input ckeditor-init" rows="5">{{ old('inclusions') }}</textarea>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" step="0.01" name="original_price" id="original_price" class="modern-input" value="{{ old('original_price') }}" required>
                    </div>
                    <div class="form-group">
                        <label for="discount_price">Discount Price ($)</label>
                        <input type="number" step="0.01" name="discount_price" id="discount_price" class="modern-input" value="{{ old('discount_price') }}">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-sm-3 mb-3">
                            <div class="form-group">
                                ...
                                <input type="number" name="duration_days" id="duration_days" class="modern-input" min="0" value="{{ old('duration_days', 0) }}">
                            </div>
                        </div>
                        <div class="col-sm-3 mb-3">
                            <div class="form-group">
                                <label for="duration_nights">Nights</label>
                                <input type="number" name="duration_nights" id="duration_nights" class="modern-input" min="0" value="{{ old('duration_nights', 0) }}">
                            </div>
                        </div>
                        <div class="col-sm-3 mb-3">
                            <div class="form-group">
                                <label for="duration_hours">Hours</label>
                                <input type="number" name="duration_hours" id="duration_hours" class="modern-input" min="0" max="23" value="{{ old('duration_hours', 0) }}">
                            </div>
                        </div>
                        <div class="col-sm-3 mb-3">
                            <div class="form-group">
                                <label for="duration_minutes">Minutes</label>
                                <input type="number" name="duration_minutes" id="duration_minutes" class="modern-input" min="0" max="59" value="{{ old('duration_minutes', 0) }}">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-sm-6 mb-3">
                            <div class="form-group">
                                ...
                                <input type="number" name="min_guests" id="min_guests" class="modern-input" min="1" value="{{ old('min_guests') }}" placeholder="No minimum">
                            </div>
                        </div>
                        <div class="col-sm-6 mb-3">
                            <div class="form-group">
                                <label for="max_guests">Maximum Guests</label>
                                <input type="number" name="max_guests" id="max_guests" class="modern-input" min="1" value="{{ old('max_guests') }}" placeholder="No maximum">
                            </div>
                        </div>
                    </div>
                </div>
