...
<div class="admin-page-panel">
    <div class="page-panel-header">
        <div class="panel-header-action-container">
            <h3><i class="fa-solid fa-plus"></i> Add New Meal</h3>
    ...
    <div class="page-panel-body">
        <form action="{{ url('/admin/meals') }}" method="POST" class="validate-form">
            @csrf
            ...
            <div class="form-section-grid" style="grid-template-columns: 1fr;">
                <div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="meal" id="meal" class="modern-input" placeholder="Enter meal name (e.g., Breakfast, Lunch)" value="{{ old('meal') }}" required>
                        @error('meal')
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description" id="description" class="modern-input" rows="4" placeholder="Enter meal description">{{ old('description') }}</textarea>
                        @error('description')
                            <span class="text-danger" style="font-size: 0.85rem; margin-top: 4px; display: block;">{{ $message }}</span>
                        @enderror
                    </div>
            ...
            <div style="display: flex; justify-content: flex-start; gap: 12px;">
                <button type="submit" class="modern-btn">
                    <i class="fa-solid fa-floppy-disk"></i> Save Meal
                </button>
