...
<div class="admin-page-panel">
    <div class="page-panel-header">
        <div class="panel-header-action-container">
            <h3><i class="fa-solid fa-plus"></i> Add New Travel Guide</h3>
    ...
    <div class="page-panel-body">
        <form action="{{ url('/admin/travel-guides') }}" method="POST" enctype="multipart/form-data" class="validate-form">
            @csrf
            ...
            <div class="form-section-grid">
                ...
                <div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="name" id="name" class="modern-input" placeholder="Enter guide name" value="{{ old('name') }}" required>
                        @error('name')
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="designation" id="designation" class="modern-input" placeholder="e.g. Senior Tour Guide" value="{{ old('designation') }}">
                        @error('designation')
                            <span class="text-danger" style="font-size: 0.85rem; margin-top: 4px; display: block;">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group" style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px;">
                        <div>
                            ...
                            <input type="email" name="email" id="email" class="modern-input" placeholder="Enter email" value="{{ old('email') }}">
                            @error('email')
                                <span class="text-danger" style="font-size: 0.85rem; margin-top: 4px; display: block;">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="address" id="address" class="modern-input" rows="4" placeholder="Enter address">{{ old('address') }}</textarea>
                        @error('address')
                            <span class="text-danger" style="font-size: 0.85rem; margin-top: 4px; display: block;">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="image-upload-wrapper">
                            ...
                            <img src="" class="image-preview" alt="Guide Preview" style="border-radius: 8px;">
            ...
            <div style="display: flex; justify-content: flex-end; gap: 12px;">
                ...
                <button type="submit" class="modern-btn">
                    <i class="fa-solid fa-floppy-disk"></i> Save Travel Guide
                </button>
            </div>
        </form>
    </div>
