...
<div class="admin-page-panel">
    <div class="page-panel-header">
        <div class="panel-header-action-container">
            <h3><i class="fa-solid fa-plus"></i> Add New User</h3>
    ...
    <div class="page-panel-body">
        <form action="{{ route('users.store') }}" method="POST" class="validate-form">
            @csrf
            
            <div class="form-input-grid">
                <div class="form-group">
                    <label>Full Name <span class="text-danger">*</span></label>
                    <input type="text" name="name" class="modern-input" value="{{ old('name') }}" placeholder="John Doe" required>
                </div>
                <div class="form-group">
                    <label>Email Address <span class="text-danger">*</span></label>
                    <input type="email" name="email" class="modern-input" value="{{ old('email') }}" placeholder="john@example.com" required>
                </div>
            </div>
            ...
            <div class="form-input-grid">
                <div class="form-group">
                    ...
                    <input type="password" name="password" class="modern-input" placeholder="e.g. Secret123" pattern="^(?=.*[A-Za-z])(?=.*\d)[A-Za-z\d@$!%*#?&]{8,}$" title="Password must be at least 8 characters long and contain both letters and numbers" required>
                ...
                <div class="form-group">
                    ...
                    <input type="password" name="password_confirmation" class="modern-input" placeholder="Confirm Password" pattern="^(?=.*[A-Za-z])(?=.*\d)[A-Za-z\d@$!%*#?&]{8,}$" required>
                </div>
            </div>
