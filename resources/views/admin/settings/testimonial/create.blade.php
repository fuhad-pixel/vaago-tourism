...
<div class="admin-page-panel">
    <div class="page-panel-header">
        <h3><i class="fa-solid fa-plus"></i> Add Testimonial</h3>
    </div>
    <div class="page-panel-body">
        
        <form action="{{ url('/admin/settings/testimonial') }}" method="POST" enctype="multipart/form-data" class="validate-form">
            @csrf
                ...
                <div>
                    ...
                    <div class="form-input-grid">
                        <div class="form-group">
                            ...
                            <input type="text" name="client_name" class="modern-input" value="{{ old('client_name') }}" placeholder="e.g. John Doe" required>
                        </div>

                        <div class="form-group">
                            <label>Designation <span class="text-danger">*</span></label>
                            <input type="text" name="designation" class="modern-input" value="{{ old('designation') }}" placeholder="e.g. CEO, Travel Agent" required>
                        </div>
                    </div>
                    ...
                    <div class="form-input-grid">
                        <div class="form-group">
                            ...
                            <input type="email" name="email" class="modern-input" value="{{ old('email') }}" placeholder="john@example.com" email="true">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="review" class="modern-input" rows="5" placeholder="Enter testimonial review..." required>{{ old('review') }}</textarea>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="image-upload-wrapper">
                            ...
                            <img src="" class="image-preview" alt="DP Preview" style="border-radius: 50%;">
            ...
            <div style="display: flex; justify-content: space-between; align-items: center;">
                ...
                <button type="submit" class="modern-btn">
                    <i class="fa-solid fa-floppy-disk"></i> Create Testimonial
                </button>
            </div>
        </form>
    </div>
