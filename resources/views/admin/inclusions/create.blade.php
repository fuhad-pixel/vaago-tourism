...
<div class="admin-page-panel">
    <div class="page-panel-header">
        <div class="panel-header-action-container">
            <h3><i class="fa-solid fa-plus"></i> Add New Inclusion</h3>
    ...
    <div class="page-panel-body">
        <form action="{{ url('/admin/additional-inclusions') }}" method="POST" class="validate-form">
            @csrf
            ...
            <div class="form-section-grid">
                ...
                <div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="name" id="name" class="modern-input" placeholder="e.g. Free Wi-Fi" value="{{ old('name') }}" required>
                        @error('name')
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="icon" id="icon" class="modern-input" placeholder="e.g. fa-solid fa-wifi" value="{{ old('icon') }}" required>
                        @error('icon')
                        <span class="text-danger" style="font-size: 0.85rem; margin-top: 4px; display: block;">{{ $message }}</span>
                        @enderror
            ...
            <div style="display: flex; justify-content: flex-end; gap: 12px;">
                ...
                <button type="submit" class="modern-btn">
                    <i class="fa-solid fa-floppy-disk"></i> Save Inclusion
                </button>
            </div>
        </form>
    </div>
